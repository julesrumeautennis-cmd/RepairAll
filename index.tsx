...
// Hardcoded Auth0 credentials. In a real production app, these would be in environment variables.
const auth0Domain = "dev-ot71skzceigld37k.us.auth0.com";
const auth0ClientId = "0VVyBUyLCOybTFxYzgeGRxsmY5HEzqXA";
    ...
    <React.StrictMode>
      <div className="min-h-screen w-full p-4 md:p-8 flex flex-col items-center justify-center bg-slate-50 text-slate-800">
        <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 text-center max-w-2xl">
          <h1 className="text-3xl font-bold text-red-600 mb-4">Configuration Requise</h1>
          <p className="text-slate-700 mb-4">
            Pour activer l'authentification, les variables d'environnement{' '}
            <code className="bg-slate-200 text-sm font-mono p-1 rounded">AUTH0_DOMAIN</code> et{' '}
            <code className="bg-slate-200 text-sm font-mono p-1 rounded">AUTH0_CLIENT_ID</code>{' '}
            doivent être définies.
          </p>
          <p className="text-slate-600">
            Veuillez créer un compte gratuit sur{' '}
            <a href="https://auth0.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline font-semibold">
              Auth0
            </a>
            , configurer une nouvelle application, et ajouter les clés correspondantes à cet environnement pour continuer.
          </p>
        </div>
      </div>
    </React.StrictMode>
